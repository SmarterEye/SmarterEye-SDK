...
//      get environment illuminace.
            ...
            if (result) {
                ...
                std::cout << "Acquired environment illuminace failed." << std::endl;
            }
        }
            break;
        case 's':
        {
//      get lens smudge status.
            int status = -1;
            bool result = false;
            result = cameraA->getSmudgeStatus(status);
            if (result) {
                switch (status) {
                case 0:
                ...
                std::cout << "Acquired lens smudge status failed." << std::endl;
            }
        }
            break;
        case 'z':
